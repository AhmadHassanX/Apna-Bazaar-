  ...
  try {
    if (btnName == "Add Product") {
      const res = await fetch(
        "https://console.firebase.google.com/u/0/project/apna-bazaar-84ee4/database/apna-bazaar-84ee4-default-rtdb/data/~2F",
        {
          method: "POST",
          headers: {
      ...
      const res = await fetch(
        `https://apna-bazaar-84ee4-default-rtdb.firebaseio.com/Product/${editingProductId}.json`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
...
async function fetchAndDisplayProducts() {
  try {
    const response = await fetch(
      "https://apna-bazaar-84ee4-default-rtdb.firebaseio.com/Product.json"
    );
...
async function editBtn(id) {
  ...
  try {
    const res = await fetch(
      `https://apna-bazaar-84ee4-default-rtdb.firebaseio.com/Product/${id}.json`
    );
